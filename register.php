                ...
                <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <form action="handler/handle_register.php" method="post">
                        <div class="form-group">
                            <label for="name" class="p-l-5" style="font-weight: 600">Name</label>
                            <div class="bor8 m-b-20 how-pos4-parent">
                                <input class="stext-111 cl2 plh3 size-116 p-lr-28" id="name" type="text" name="name" placeholder="Enter your name">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="phone" class="p-l-5 " style=" font-weight: 600">Phone number</label>
                            <div class="bor8 m-b-20 how-pos4-parent">
                                <input class="stext-111 cl2 plh3 size-116 p-lr-28" id="phone" type="text" name="phone" placeholder="Enter your phone number">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="address" class="p-l-5" style="font-weight: 600">Address</label>
                            <div class="bor8 m-b-20 how-pos4-parent">
                                <input class="stext-111 cl2 plh3 size-116 p-lr-28" id="address" type="text" name="address" placeholder="Enter your address">
                            </div>
                        </div>
