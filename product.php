...
<body class="animsition" style="height: 100vh;">
  ...
  <div class="bg0 m-t-23 p-b-140">
    <div class="container">
      ...
      <div class="row isotope-grid">
        ...
        $stmt->execute();
        $stmt->store_result();
        $stmt->bind_result($id, $photo_path, $name, $price, $category);

        while ($stmt->fetch()) { ?>
          <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $category ?>">
            <!-- Block2 -->
            <div class="block2">
              <div class="block2-pic hov-img0">
                <img src="<?php echo $photo_path ?>" alt="IMG-PRODUCT" />

                <a href="details.php?id=<?php echo $id ?>" class="
                      block2-btn
                      flex-c-m
                      stext-103
                      cl2
  ...
  <script>
    ...
    document.querySelector('.nav-shop').classList.add('active-menu');
  </script>
</body>
